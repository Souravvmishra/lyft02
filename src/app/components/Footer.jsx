  ...
  return (
    <div className=' mx-40 py-10'>
      ...
      <div className='flex justify-between'>
        ...
        <div className=''>
          <div className='mb-4'>
            <button className='w-36 px-2 rounded-full border text-black border-black py-1 hover:bg-slate-200'>Lyft driver app</button>
          </div>
          <div className=''>
            <button className='w-36 px-2 rounded-full border text-black border-black py-1 hover:bg-slate-200'>Lyft rider app</button>
          </div>
        </div>
